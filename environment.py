...
# NEW:
        ...
        self.__double_move_probs = {a: 0.1 for a in ROBOT_ACTIONS}
        self.__drift_cw_probs = {a: 0.05 for a in ROBOT_ACTIONS}
        self.__drift_ccw_probs = {a: 0.05 for a in ROBOT_ACTIONS}

        # penalties
        # self.__collision_penalty = random.uniform(0.1, 5.0)
        # self.__hazard_penalty = random.uniform(1.0, 20.0)
        self.__collision_penalty = 2.5
        self.__hazard_penalty = 10

        # action costs
        # self.__action_costs = {a: random.uniform(0.1, 3.0) for a in ROBOT_ACTIONS}
        self.__action_costs = {a: 1 for a in ROBOT_ACTIONS}
